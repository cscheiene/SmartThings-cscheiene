...
*/ 
metadata {
	definition (name: "Heatit Thermostat Modified", namespace: "cscheiene", author: "AdamV", ocfDeviceType: "oic.d.thermostat", vid: "SmartThings-smartthings-Z-Wave_Thermostat") {
		capability "Actuator"
	...
	tiles (scale: 2){
        ...
        */
        ...
        standardTile("mode", "device.thermostatMode", inactiveLabel: false, decoration: "flat", width: 2, height: 2) {
			...
			state "heat", label:'Heat', action:"switchMode", nextState:"working", icon:"st.Home.home1"
